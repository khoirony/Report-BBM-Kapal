            ...
            <div class="flex flex-col md:flex-row justify-between gap-4">
                ...
                <div class="flex flex-row gap-3 w-full md:w-auto">
                    ...
                    <div class="relative flex-1 md:flex-none md:w-48">
                        <select wire:model.live="sortBy" class="pl-4 pr-8 py-2.5 bg-slate-50 border border-slate-200 text-slate-700 text-sm font-medium rounded-xl focus:ring-2 focus:ring-indigo-500 block w-full appearance-none shadow-sm cursor-pointer">
