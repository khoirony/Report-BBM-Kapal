        ...
        <div x-data="{ showFilters: false }" class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 mb-6 space-y-4">
            ...
            <div class="flex flex-col md:flex-row justify-between gap-4">
                <div class="relative w-full md:w-1/2 lg:w-1/3">
                    ...
                    <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari keterangan, nama armada, atau petugas..." class="pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 text-slate-900 text-sm rounded-xl focus:ring-2 focus:ring-indigo-500 block w-full transition-colors shadow-sm">
                </div>
                ...
                <table class="w-full text-sm text-left text-gray-600 block md:table">
                    <thead class="hidden md:table-header-group text-xs text-gray-500 uppercase bg-slate-50 border-b border-gray-100">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-5 font-bold tracking-wider w-1/6">Pemeriksaan & Petugas</th>
                        ...
                        @forelse($groupedSoundings as $groupKey => $records)
                            ...
                            <tr class="relative block md:table-row bg-white hover:bg-slate-50/50 transition-colors duration-150 border-b border-gray-100 last:border-b-0">
                                ...
                                <td class="relative flex flex-col md:table-cell pl-12 pr-4 py-3 md:pl-6 md:pr-6 md:py-5 border-b border-gray-50 md:border-none align-middle z-10">
                                    ...
                                    <span class="text-[10px] font-bold text-indigo-400 uppercase md:hidden mb-1 tracking-wider relative z-10">Pemeriksaan & Petugas</span>
                                    <div class="flex flex-col space-y-2 w-max relative z-10">
                                        <div class="flex items-center text-xs font-semibold text-gray-700 bg-blue-50/50 px-2.5 py-1.5 rounded-lg border border-blue-100" title="Jam Pemeriksaan">
                                        ...
                                        @if($row->petugas_sounding)
                                        <div class="flex items-center text-[11px] font-medium text-emerald-700 bg-emerald-50 px-2.5 py-1.5 rounded-lg border border-emerald-100" title="Petugas Lapangan">
                                            <svg class="w-3.5 h-3.5 text-emerald-500 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                                            {{ $row->petugas_sounding }}
                                        </div>
                                        @endif
                                    </div>
                                </td>
                    ...
                    <form wire:submit.prevent="store" id="form-sounding">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div class="col-span-1 sm:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-5">
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-slate-700 mb-1.5">Jam Periksa (WIB) <span class="text-rose-500">*</span></label>
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-slate-700 mb-1.5">Petugas <span class="text-rose-500">*</span></label>
                                    <input type="text" wire:model="petugas_sounding" placeholder="Nama Petugas" class="px-4 py-2.5 bg-slate-50 border border-slate-200 text-slate-900 text-sm rounded-xl focus:ring-2 focus:ring-indigo-500 block w-full transition-colors" required>
                                    @error('petugas_sounding') <span class="text-rose-500 text-xs mt-1 block">{{ $message }}</span>@enderror
                                </div>
                            </div>
