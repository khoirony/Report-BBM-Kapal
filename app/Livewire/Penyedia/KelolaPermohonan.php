...
class KelolaPermohonan extends Component
{
    use WithPagination;
    ...
    {
        $queryTugas = SuratTugasPengisian::with('laporanSebelumPengisianBbm.kapal');
    ...
    public function render()
    {
        ...
        return view('livewire.penyedia.kelola-permohonan', [
